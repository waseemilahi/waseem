...
class Job{
		...
		public:
             ...
             Job(long jobnum,long prty,long size,long maxtime,long currenttime);
      		 ...
      		 // The prototypes for all the accessors and mutators.
      ...
      private:
             ...
             long cpu_time_used;//The time job has used so far.
             long time_slice;//The time quantum
              //used for determining the time slice.
             long time_job_ran;
             long time_job_stopped;

             //The flags or the required bits.
             struct flags{
                          unsigned incore: 1;
