...
int derive(char gammaprime[500][100],char* query,int counter);
...
int main(int argc,char** argv){
   ...
   while(e==0 && level1<=k){
    ...
    //Getting the Gamma Set.
     ...
     success=derive(gammaprime1,query,aacounter1);
     ...
     printf("\n -----------------------------------------------------------\n");
     printf("\n The Result with 'Our' Way     (considering the relevence ).\n");
     printf("\n ***********************************************************\n");
     ...
     success=derive(sigmaprime1,query,counter);
...
//The function for derivation.

int derive(char gammaprime1[500][100],char* query, int aacounter1)
{                   
     char* tmparray;
     list<char*> *tmplist2=new list<char*>();
     char tmpsymbol1[100][1],tmpantisymbol1[100][2];
     list<list<char*>* > *tmpqueue1=new list<list<char*>* >();
     int success=0,notfinished=1,counteras1=0,counters1=0,nf1;
     ...
     while(notfinished==1){  printf("\n NOT FINISHED!!!\n");
            ...
            printf("\n success=%d\n",success);
                ...
                if(notfinished==0 && counteras1+counters1!=tmplist2->size())notfinished=1;
            if(!notfinished && counteras1+counters1>=tmplist2->size()){printf("\n yes...\n");
              success=0;break;
            }

          printf("\n %s \n", tmplist2->front());
          tmparray=tmplist2->front();printf("\n %s \n", tmparray);
          tmplist2->pop_front();
            ...
            if(strlen(tmparray)==1){
              ...
              for(int f=0;f<counteras1;f++){
                 ...
                 if(nf1==1){
                   ...
                   if(!tmpqueue1->empty()){
                     printf("\n %s | %s \n",tmpqueue1->front()->front(),tmpqueue1->front()->back());
                     tmplist2=tmpqueue1->front();printf("\n NEXT LIST ON QUEUE.\n");
                     for(int f=0;f<sizeof(tmpsymbol1);f++){
                        tmpantisymbol1[f][0]=0;tmpsymbol1[f][0]=0;
                     }
                        continue;
                   }
                ...
                int openp=0,closep=0;
                char tmparray3[4][100];char tmparray2[100]="";
                list<char*>* tmpl1=new list<char*>();
                ...
                if(tmparray[0]=='~'){   printf("\n NOT!!!!!!!!\n");
                   for(unsigned int r=1;r<strlen(tmparray);r++){
                		  ...
                		  for(unsigned int r=0;r<strlen(tmparray);r++){
                           ...
                           if(openp-1==closep && tmparray[r]=='&'){
                             unsigned int f,g;
                             for(f=1;f<r;f++)tmparray3[0][f-1]=tmparray[f];tmparray3[0][f-1]=0;
                             tmplist2->push_front(tmparray3[0]);printf("\n %s \n",tmplist2->front());

                             for(g=r+1;g<strlen(tmparray)-1;g++)tmparray3[1][g-(r+1)]=tmparray[g];
                             tmparray3[1][g-(r+1)]=0;
                             tmplist2->push_front(tmparray3[1]);printf("\n %s \n",tmplist2->front());

                              break;
                           }
                           else if(openp-1==closep && tmparray[r]=='|'){
                                  unsigned int f,g;
                                  for(g=r+1;g<strlen(tmparray)-1;g++)tmparray3[0][g-(r+1)]=tmparray[g];
                                  tmparray3[0][g-(r+1)]=0;
                                  printf("\n %s\n",tmparray); printf("\n %s\n",tmparray3[0]);

                                  tmpl1->push_back(tmparray3[0]);    printf("\n %s\n",tmpl1->back());

                           while(!tmplist2->empty()){

                               strcpy(tmparray2,tmplist2->front());
                           ...
                           while(!tmpl2->empty()){
                                  ...
                                  for(f=1;f<r;f++)tmparray3[1][f-1]=tmparray[f];
                                  tmparray3[1][f-1]=0;
                                     printf("\n %s\n",tmparray); printf("\n %s\n",tmparray3[1]);
                                  tmplist2->push_front(tmparray3[1]);
                                  printf("\n listsize=%d\n",tmplist2->size());
                                  printf("\n %s\n",tmplist2->front());
                           	    ...
                           	    unsigned int f,g;
                                  for(g=r+2;g<strlen(tmparray)-1;g++)tmparray3[0][g-(r+2)]=tmparray[g];
                                  tmparray3[0][g-(r+2)]=0;
                                  printf("\n %s\n",tmparray); printf("\n %s\n",tmparray3[0]);
                           ...
                           while(!tmpl2->empty()){
                            ...
                            if(tmparray[1]!='~'){
                                  tmparray3[1][0]='~';
                                   for(f=1;f<r;f++)tmparray3[1][f]=tmparray[f];
                                  tmparray3[1][f]=0;
                                     printf("\n %s\n",tmparray); printf("\n %s\n",tmparray3[1]);
                                  tmplist2->push_front(tmparray3[1]);
                                  printf("\n listsize=%d\n",tmplist2->size());
                                  ...
                                  if(tmparray[r+3]!='~'){
                                     ...
                                     tmparray3[1][0]='~';
                                      ...
                                      for(g=r+3;g<strlen(tmparray)-1;g++)tmparray3[1][g-(r+3)+1]=tmparray[g];
                                      tmparray3[1][g-(r+3)+1]=0;
                                      tmpl1->push_back(tmparray3[1]);

                                  }
                                  else if(tmparray[r+3]=='~'){

                                        for(g=r+3;g<strlen(tmparray)-1;g++)tmparray3[1][g-(r+3)]=tmparray[g];
                                        tmparray3[1][g-(r+3)]=0;
                                        tmpl1->push_back(tmparray3[1]);
                                  ...
                                  if(tmparray[1]!='~'){
                                     ...
                                     tmparray3[0][0]='~';
                                      ...
                                      for(f=1;f<r;f++)tmparray3[0][f]=tmparray[f];
                                      tmparray3[0][f]=0;
                                      tmpl1->push_back(tmparray3[0]);
                                   }
                                   else if(tmparray[1]=='~'){

                                      for(f=1;f<r;f++)tmparray3[0][f-1]=tmparray[f];
                                        tmparray3[0][f-1]=0;
                                        tmpl1->push_back(tmparray3[0]);
                          ...
                          while(!tmplist2->empty()){
                           ...
                           while(!tmpl2->empty()){
                                  ...
                                  for(f=1;f<r;f++)tmparray3[2][f-1]=tmparray[f];
                                  tmparray3[2][f-1]=0;
                                  tmplist2->push_back(tmparray3[2]);

                                  for(g=r+3;g<strlen(tmparray)-1;g++)tmparray3[3][g-(r+3)]=tmparray[g];
                                  tmparray3[3][g-(r+3)]=0;
                                  tmplist2->push_back(tmparray3[3]);
     ...
     if(success==1)break;
            ...
            printf("\n success=%d\n",success);
                ...
                if((counteras1+counters1)<tmplist2->size()){notfinished=1;printf("\n yes1...\n");}
            if(notfinished==0 && (counteras1+counters1)>=tmplist2->size()){printf("\n yes2...\n");
               break;} printf("\n yes22...\n");
                   ...
                   tmplist2=tmpqueue1->front();printf("\n NEXT LIST ON QUEUE.\n");
                      for(int f=0;f<sizeof(tmpsymbol1);f++){
                       ...
                       tmplist2->push_back(tmparray);
                                          ...
                                          success=0;
                int openp=0,closep=0;
                char tmparray2[100]="";char tmparray3[2][100];
                list<char*>* tmpl1=new list<char*>();
                list<char*>* tmpl2=new list<char*>();
                if(tmparray[0]=='~'){
                   for(unsigned int r=1;r<strlen(tmparray);r++){
                		  ...
                		  for(unsigned int r=0;r<strlen(tmparray);r++){
                           ...
                           while(!tmpl2->empty()){
                                  ...
                                  tmparray3[1][f-1]=0;
                                     printf("\n %s\n",tmparray); printf("\n %s\n",tmparray3[1]);
                                  tmplist2->push_back(tmparray3[1]);
                                  printf("\n listsize=%d\n",tmplist2->size());
                                  printf("\n %s\n",tmplist2->back());
