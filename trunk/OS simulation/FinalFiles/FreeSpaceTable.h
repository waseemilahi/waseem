//Waseem Ilahi    /*The method used is first fit (FF)*/
...
class FreeSpaceTable{
      ...
      //This method finds the space of a given size and returns pointer to it.
            FreeSpace* findspace(long size);

            //This method returns the 'mytable'member of the table.
               ...
               vector<FreeSpace>::iterator iter3=this->mytable->begin();
                 ...
                 while(i<this->mytable->size() && iter3!=this->mytable->end()){
                            tmp1=iter3;
                              ...
                              //The whole space has been taken
...
void FreeSpaceTable::freememory(long address1,long size1){
    ...
    tmp2.setsize(size1);
        //When the size is zero meaning no space.
             ...
             if(l==0){
               if(tmp2.getaddress()<tmp4.getaddress()){
                ...
                if(tmp4.getaddress()+tmp4.getsize()==tmp2.getaddress()){
                  ...
                  if(mytable->at(l).getaddress()+mytable->at(l).getsize(
                    )==mytable->at(l+1).getaddress()){
                     mytable->at(l).setsize(mytable->at(l).getsize()
                                            +mytable->at(l+1).getsize());
                     iter3++;
                      mytable->erase(iter3);
                  }
                  ...
                  if(tmp2.getaddress()+tmp2.getsize()==mytable->at(l+1).
                    getaddress()){
                    mytable->at(l+1).setaddress(mytable->at(l+1).getaddress()
                                                -size1);
           ...
           //The intermediate spaces
                ...
                if(tmp2.getaddress()<tmp4.getaddress()){
                 if(mytable->at(l-1).getaddress()+mytable->at(l-1)
                    .getsize()==tmp2.getaddress()){
                   mytable->at(l-1).setsize(mytable->at(l-1).getsize()
                                            +tmp2.getsize());
                  if(mytable->at(l-1).getaddress()+mytable->at(l-1).getsize()
                    ==mytable->at(l).getaddress()){
                       mytable->at(l-1).setsize(mytable->at(l-1).getsize()
                                               +mytable->at(l).getsize());
                       mytable->erase(iter3);
                  }
                 }
                else if(mytable->at(l-1).getaddress()+mytable->at(l-1).getsize()
                       !=tmp2.getaddress()){
                       if(tmp2.getaddress()+tmp2.getsize()==tmp4.getaddress()){
                        mytable->at(l).setaddress(tmp4.getaddress()-size1);
                         mytable->at(l).setsize(tmp4.getsize()+size1);
                       }
                       else if(tmp2.getaddress()+tmp2.getsize()
                                !=tmp4.getaddress()){
                          mytable->insert(iter3,tmp2);
                       }
                 }
           ...
           //The last emtry.
                ...
                if(tmp2.getaddress()<tmp4.getaddress()){
                 if(mytable->at(l-1).getaddress()+mytable->at(l-1).getsize()
                   ==tmp2.getaddress()){
                   mytable->at(l-1).setsize(mytable->at(l-1).getsize()+tmp2.
                                            getsize());
                   if(mytable->at(l-1).getaddress()+mytable->at(l-1).getsize()
                     ==mytable->at(l).getaddress()){
                    mytable->at(l-1).setsize(mytable->at(l-1).getsize()
                 ...
                 else if(mytable->at(l-1).getaddress()+mytable->at(l-1).
                         getsize()!=tmp2.getaddress()){
                  if(tmp2.getaddress()+tmp2.getsize()==tmp4.getaddress()){
                   mytable->at(l).setaddress(tmp4.getaddress()-size1);
                    mytable->at(l).setsize(tmp4.getsize()+size1);
